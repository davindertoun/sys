...
<table class="table table-hover">
  ...
  <tbody>
    ...
    <?php if($leave->user->role_id==1 || $leave->user->role_id ==2): ?>
      <?php ($count++); ?>
      <tr>
        ...
        <td scope="col">
          <?php if($leave->state_id == 1): ?>
            <a href="<?php echo e('accept_tl_leave/'.encrypt($leave->id)); ?>" class='btn btn-success'>Accept</a>
            <a href="<?php echo e('reject_tl_leave/'.encrypt($leave->id)); ?>" class='btn btn-danger'>Reject</a>
          <?php endif; ?> 
    ...
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <?php /**PATH C:\xampp\htdocs\laravel\resources\views/frontend/tl_leave.blade.php ENDPATH**/ ?>