...
<div class="row">
    <div class="col-md-4">
        <form action="<?php echo e(url('employee_attendance')); ?>" enctype="multipart/form-data" method="POST">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('frontend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\resources\views/frontend/edit_attendance.blade.php ENDPATH**/ ?>