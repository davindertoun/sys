...
<table class="table table-hover">
	...
	<?php $__currentLoopData = $Attendance; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attendance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
		<?php if($attendance->user->role_id==1): ?>
			<?php ($count++); ?>
			<tr>
			...
			<td><a href="<?php echo e('edit/'.encrypt($attendance->id)); ?>" class="btn btn-primary btn-sm"> Edit</a></td>
		<?php endif; ?>
			</tr>
	<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</table>
<?php /**PATH C:\xampp\htdocs\laravel\resources\views/frontend/employee_data.blade.php ENDPATH**/ ?>